...
- Çıktı URI önceden item üzerinde varsa kullanılır. Yoksa job'ın persist edilmiş output tree URI'sinde SAF ile hedef belge üretilir. Motorlar kendi güvenli temp çıktısını tamamladıktan sonra hedef URI'ye kopyalar; worker'ın ürettiği yarım belge hata/iptalde silinir, UI'nın önceden verdiği mevcut çıktı URI'si izinsiz silinmez.
